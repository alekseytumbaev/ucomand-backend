...
public class VacancyFilterDto extends AdFilterDto {
    ...
    public VacancyFilterDto(Long userId, Set<Gender> genders, Integer ageFrom, Integer ageTo, Set<String> cities, Set<TagDto> tags, Set<VisibilityLevel> visibilities, OffsetDateTime creationDateFrom, OffsetDateTime creationDateTo) {
